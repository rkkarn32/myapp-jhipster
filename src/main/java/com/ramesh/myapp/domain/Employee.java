...
public class Employee implements Serializable {
    ...
    private Set<House> houseNums = new HashSet<>();
    ...
    public Set<House> getHouseNums() {
        return houseNums;
    }

    public Employee houseNums(Set<House> houses) {
        this.houseNums = houses;
        return this;
    }

    public Employee addHouseNum(House house) {
        this.houseNums.add(house);
        house.setEmployee(this);
        return this;
    }

    public Employee removeHouseNum(House house) {
        this.houseNums.remove(house);
        house.setEmployee(null);
        return this;
    }

    public void setHouseNums(Set<House> houses) {
        this.houseNums = houses;
    }
