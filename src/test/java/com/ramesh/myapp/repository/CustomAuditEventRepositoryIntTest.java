...
import com.ramesh.myapp.config.audit.AuditEventConverter;
import com.ramesh.myapp.domain.PersistentAuditEvent;
...
import static com.ramesh.myapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
